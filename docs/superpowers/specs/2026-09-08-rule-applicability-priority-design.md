...
日期：2026-09-08。状态：用户已确认总体方向和优先级定义；本详细设计待审阅，尚未实施。
...
总体方向与“官方 > 明确全局 > 本地”的含义已获用户确认。本文件将其落为 profile、v2 契约和启发式人工复核的具体方案，仍需用户审阅后再写实施计划。文档完成不等于代码已修改、规则已迁移、检查已通过或版本已发布。
