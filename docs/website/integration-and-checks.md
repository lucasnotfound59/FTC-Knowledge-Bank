...
本文是文档站新增功能的技术正文，按网站七个栏目组织。安装细节以 [项目接入指南](../project-integration.md) 为准，机器输出以 [Kernel 契约](../kernel-contract.md) 为准。当前仓库版本为 V0.9.0（CLI 2.1.0、YAML v4、kernel JSON v2、项目接入协议 v2；48 条规则 = 42 已批准 + 6 候选）；接入功能的公开可用版本需在发布前确认，不能将 README 中的 V0.1.1 当作包含新功能的已发布 tag。
