...
```bash
./gradlew :apps:knowledge-cli:installDist   # 需 JDK 21，产物在
# apps/knowledge-cli/build/install/knowledge-cli/bin/ftckb
```

本仓库 `.worktrees/cli-agent/apps/knowledge-cli/build/install/knowledge-cli/bin/ftckb`
...
- 文档中的规则数/测试数快照（当前 27 条规则、389 项测试）随改动同步更新。
